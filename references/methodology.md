...
- "做得好"一节：对应 what went well；同时有学习科学依据（见下）
...
- 自我效能感是中介机制 → 复盘必须记录"做对了什么"（第 4 节做得好），只挑错会削弱继续学习的动力
...
- 第 9 节"自我检验"：AI 出题、**留白给用户盲答**，答完对照订正——这是本 skill 与"AI 替你总结"的本质区别
- 理解程度四级标尺（能看懂 / 能复述 / 能独立做 / 能教别人）
- "关键点用自己的话写，不搬 AI 原话"
- 针对反面提醒：要求"答完对照第 3、5 节订正"，防止自说自话的虚假掌握

## 间隔复习

**来源**：遗忘曲线（Ebbinghaus）与间隔重复（spaced repetition）；实用节奏见 [1-3-7-14-30 天法](https://www.lexielearn.com/guides/spaced-repetition-study-method)、[BCU 2357 法](https://www.bcu.ac.uk/exams-and-revision/best-ways-to-revise/spaced-repetition)

**核心**：在即将遗忘前复习，用间隔递增的复习对抗遗忘曲线。

**在本 skill 中的应用**：

- 第 10 节复习计划：3 天 / 1 周 / 1 个月三档（对 1-3-7-14-30 的裁剪：复盘文档不是记忆卡，三档足够且不增加负担）
- 复习动作绑定"盲答自测"（检索练习）而非重读
...
- 术语全程一致：复盘 / 时间线 / 根因链 / 尝试记录 / 做得好 / 行动项 / 自我检验 / 复习计划
